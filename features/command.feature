Feature: Command
  ...
  Scenario: Go command with parameters
    Given I have an executable "example" with output "reports"
    When I create the go command with command "serve" and parameters "--level=info"
  ...
  Scenario: Go command without parameters
    Given I have an executable "example" with output "reports"
    When I create the go command with command "serve" and parameters ""
